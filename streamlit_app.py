...
# Initialize conversation and document states
...
# Initialize session state variables for file content
if 'uploaded_file_content' not in st.session_state:
    st.session_state.uploaded_file_content = ""  # Stores the content of the current file
...
def process_file():
    ...
    if uploaded_file:
        ...
        if uploaded_file.type == "application/pdf":
            ...
            st.session_state.uploaded_file_content = "".join([page.extract_text() for page in pdf_reader.pages])
            ...
            st.session_state.uploaded_file_content = "Unsupported file format."
...
# File uploader with on_change to process file upload
st.file_uploader("Upload a file", type=["pdf", "docx", "txt"], key="file_uploader", on_change=process_file)

# Display the processed file content
...
def generate_response(prompt):
    ...
    user_prompt = f"{prompt}\n\nDocument content for reference: {st.session_state.uploaded_file_content}" if st.session_state.uploaded_file_content else prompt
